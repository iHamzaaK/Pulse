...
final class FullArticleViewModel {
  private let headerTitle = ""
  private let navBarType : navigationBarTypes
  private let repository : ArticleDetailRepository
  private let articleID : String
  private var articleComments = [PostDetailComment]()
  private let bookmarkRepository : BookmarksRepository
  ...
  func getVideoURl()->URL?{
    guard let videoURL = URL.init(string: articleData.videoUrl ?? "") else { return  nil }
    return videoURL
  }
